var section2 = [
  ...
  },
  {
    ...
    "tips":[
      {"relevance":"Donec quis arcu commodo, congue nibh ut, placerat ex."},
      {"meaning":""},
  ...
  },
  {
    ...
    "answers":[
      {
        ...
        "routineEntry":"Nam tortor nisi, imperdiet ac turpis a, consectetur tempus nisi. Nulla fringilla nisl nec erat facilisis, vel suscipit mi finibus. Cras mollis id quam id malesuada.",
        "appendixEntry":[
          {
            "reviewList":"",
            "tipList": "",
      ...
      },
      {
        ...
        "routineEntry":"Vivamus egestas accumsan libero, vel laoreet magna commodo nec.",
        "appendixEntry":[
          {
            "reviewList":"",
            "tipList": "",
    ...
    "tips":[
      {"relevance":""},
      {"meaning":"Curabitur in nulla volutpat eros vulputate pharetra. Praesent eu nibh id lorem consequat hendrerit. Phasellus imperdiet dui at ornare luctus. Donec urna turpis, ullamcorper a lorem nec, pharetra cursus nibh. Duis id vulputate nunc, sit amet gravida justo."},
      {"implementation":"Suspendisse aliquam elit in enim porta, non mattis tellus mattis. Etiam euismod diam velit. Quisque venenatis metus vitae dolor placerat, id euismod nibh blandit."},
      {"more": [""]}
    ]
  },
  {
