templates.questionsTemplate = function(data, params){
  ...
  content += '<div class="btn-wrap wrap-r">'+pause+'<div><button id="submitAnswers" onclick="handleSubmit()" class="nextButton btn btn-prim" title="Click or press Enter to go to the next question">Got it!</button></div></div></div>';
  return content;
};
